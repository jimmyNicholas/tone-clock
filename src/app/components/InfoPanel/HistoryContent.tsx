...
const HistoryContent: React.FC = () => (
  <div className="flex-1 w-96 text-left space-y-4 text-sm">
    ...
    <p>
      Eventually I learned to code and built another musical thing using the <LinkWithTooltip href="https://tonejs.github.io/">Tone.js library</LinkWithTooltip> - which got me thinking about that old clock project again.
    </p>
    <p>
